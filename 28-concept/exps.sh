...
### Independent Model
python exps.py lung Concept_XtoC --seed 1 -ckpt 1 -log_dir ConceptModel/outputs/ -e 1000 -optimizer sgd -pretrained -use_aux -use_attr -weighted_loss multiple -data_dir ../processed/original_28 -normalize_loss -b 16 -weight_decay 0.00004 -lr 0.0001 -scheduler_step 1000 -bottleneck
